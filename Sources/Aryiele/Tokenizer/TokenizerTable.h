...
namespace Aryiele
{
    ...
    {{   0,                           TokenizerTokens_Number,  TokenizerTokens_String,  TokenizerTokens_Operator, TokenizerTokens_Scope,   TokenizerTokens_Identifier, TokenizerTokens_EOL,     TokenizerTokens_StringQuote, TokenizerTokens_Space,  TokenizerTokens_Newline, TokenizerTokens_Unknown },
    ...
    {    TokenizerTokens_EOL,         TokenizerTokens_Reject,  TokenizerTokens_Reject,  TokenizerTokens_Reject,   TokenizerTokens_Reject,  TokenizerTokens_Reject,     TokenizerTokens_Reject,  TokenizerTokens_Reject,      TokenizerTokens_Reject, TokenizerTokens_Reject,  TokenizerTokens_Reject  },
